(function(d){d.cColorSwitcher=function(b){b=d.extend({position:"left",switcherTitle:"No Colors",switcherColors:[],switcherTarget:""},b);var a=d('<div id="cColorSwitcher"></div>'),e=d("body");a.css({position:"fixed",top:"30%",left:"-250px",transform:"translateY(-50%)","z-index":"99999"}).addClass("clearfix");d('<div class="ccs--body"><h6 style="margin: 0; font-size: 16px; line-height: 24px;">'+b.switcherTitle+'</h6><ul style="margin: 0; padding: 0; list-style: none; overflow: hidden"></ul></div>').css({width:"250px",
